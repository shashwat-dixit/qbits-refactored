...
const Team = () => {
  const facultyData = [
    {
      imageName: vasuda,
      name: "Dr. Vasudha Hegde",
      post: "HOD, EEE Dept",
      link: "mailto:vasudha.hegde@nmit.ac.in",
    },
    {
      imageName: premila,
      name: "Dr. Premila Manohar",
      post: "Professor, EEE Dept",
      link: "mailto:premila.manohar@nmit.ac.in",
    },
    {
      imageName: samanvitha,
      name: "Dr. N. Samanvita",
      post: "Professor & Head of ICAP Lab",
      link: "mailto:samanvitha.n@nmit.ac.in",
    },
    {
      imageName: shruti,
      name: "Mrs. Shruti Gatade",
      post: "Assistant Professor, EEE Dept",
      link: "mailto:shruti.gatade@nmit.ac.in",
    },
    {
      imageName: sowmya,
      name: "Mrs.Sowmya Raman",
      post: "Assistant Professor, EEE Dept",
      link: "mailto:sowmya.raman@nmit.ac.in",
    },
  ];
  return (
    <div className="team" id="team">
        ...
        {facultyData.map((item) => {
          return (
            <div className="cardTeam">
              <div>
                <img src={item.imageName} alt="events icon" />
              </div>
              <h4>{item.name}</h4>
              <h5>{item.post}</h5>
      ...
      <div className="cardsBo">
        <div className="cardTeam">
          <div>
            <img src={karthiganesh} alt="events icon" />
          </div>
      ...
      <h3 className="teamName">Club Leads</h3>
      <div className="cardsBo">
        <div className="cardTeam">
          <div>
            <img src={sudhakar} alt="events icon" />
          </div>
          <h4>N.M. Sudhakar</h4>
          <h5>President</h5>
          <a
            className="link__style1"
            href="https://www.linkedin.com/in/sudhakar-nm-b646161a9"
          >
            <img
              className="icon__style1"
              src={linkedInIcon}
              alt="linkedInIcon"
            />
          </a>
        ...
        <div className="cardTeam">
          <div>
            <img src={uttkarsh} alt="events icon" />
          </div>
          <h4>Uttkarsh Sharma</h4>
          <h5>Vice President</h5>
          <a
            className="link__style1"
            href="mailto:1nt19ee105.uttkarsh@nmit.ac.in"
          >
            <img className="icon__style1" src={EmailIcon} alt="EmailIcon" />
          </a>
        </div>
      </div>
      <h3 className="teamName">Department Heads</h3>
      <div className="cardsBo">
        <div className="cardTeam">
          <div>
            <img src={nihal} alt="events icon" />
          </div>
          <h4>Nihal K.P.</h4>
        ...
        <div className="cardTeam">
          <div>
            <img src={thaseel} alt="events icon" />
          </div>
          <h4>Thaseel</h4>
          <h5>Talks and Workshops</h5>
        ...
        <div className="cardTeam">
          <div>
            <img src={vidyashree} alt="events icon" />
          </div>
          <h4>Vidyashree</h4>
        ...
        <div className="cardTeam">
          <div>
            <img src={aishwarya} alt="events icon" />
          </div>
          <h4>Aishwarya</h4>
          <h5>Website</h5>
          ...
          <a
            className="link__style1"
            href="mailto:ekhellikaraishwarya@gmail.com"
          >
            <img className="icon__style1" src={EmailIcon} alt="EmailIcon" />
          </a>
        </div>
        <div className="cardTeam">
          <div>
            <img src={anjali} alt="events icon" />
          </div>
          <h4>Anjali Patil</h4>
        ...
        <div className="cardTeam">
          ...
          <div>
            <img src={shashwat} alt="events icon" />
          </div>
          <h4>Shashwat Dixit</h4>
          <h5>Technical Head</h5>
          <a
            className="link__style1"
            href="https://www.linkedin.com/in/02shashwat/"
          >
            <img
              className="icon__style1"
              src={linkedInIcon}
      ...
      <div className="cardsBo">
        <div className="cardTeam">
          <div>
            <img src={akruti} alt="events icon" />
          </div>
        ...
        <div className="cardTeam">
          <div>
            <img src={vismaya} alt="events icon" />
          </div>
          <h4>Vismaya</h4>
          <h5>Newspaper & Magazine</h5>
          <a
            className="link__style1"
            href="https://www.linkedin.com/in/vismaya-devashya-a538a9246"
          >
            <img
              className="icon__style1"
              src={linkedInIcon}
